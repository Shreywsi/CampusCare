      ...
      <div className="w-full max-w-lg">
        ...
        <div className="text-center mb-6">
          <h1 className="text-4xl font-extrabold text-white mb-2 tracking-wide">
            Doctor <span className="text-[#31a2b4]">Registration</span>
          </h1>
          <p className="text-white/80 text-sm">Join CampusCare and start managing patient care</p>
        </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  name="name"
                  type="text"
                  placeholder="Dr. subhodip pramanik"
                  value={form.name}
