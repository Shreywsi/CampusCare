      ...
      <div className="w-full max-w-lg">
        ...
        <div className="text-center mb-6">
          <h1 className="text-4xl font-extrabold text-white mb-2 tracking-wide">
            Student <span className="text-[#31a2b4]">Login</span>
          </h1>
          <p className="text-white/80 text-sm">Welcome back! Access your medical records and appointments</p>
        </div>
        ...
        >
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  name="email"
                  type="email"
                  placeholder="student@nitsikkim.ac.in"
                  value={form.email}
            ...
            <div className="text-right">
              <Link
                to="/forgot-password"
                className="text-sm text-[#31a2b4] hover:text-[#153761] transition-colors duration-200"
              >
                Forgot password?
              </Link>
            </div>
